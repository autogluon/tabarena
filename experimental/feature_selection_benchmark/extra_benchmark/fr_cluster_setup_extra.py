...
from tabflow_slurm.setup_slurm_base_v2 import ExtraBenchmarkSetup2026, PathSetup, SlurmSetup
...
@dataclass
class TabArenaExtraBenchmarkSetup(ExtraBenchmarkSetup2026):
...
class FSBenchmarkConfig:
    ...
    def get_default_preprocessing_configs(self, fs_methods: list[str]) -> list[str]:
        ...
        from tabarena.benchmark.feature_selection_methods.feature_selection_benchmark_utils import (  # noqa: PLC0415
