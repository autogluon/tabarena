...
ag_140_eq_4h8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_eq_4h8c",
    name="AutoGluon 1.4 (extreme, 4h)",
    **_gpu_kwargs,
)

ag_140_eq_1h8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_eq_1h8c",
    name="AutoGluon 1.4 (extreme, 1h)",
    **_gpu_kwargs,
)

ag_140_eq_5m8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_eq_5m8c",
    name="AutoGluon 1.4 (extreme, 5m)",
    **_gpu_kwargs,
)

ag_140_bq_4h8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_bq_4h8c",
    name="AutoGluon 1.4 (best, 4h)",
    **_cpu_kwargs,
)

ag_140_bq_1h8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_bq_1h8c",
    name="AutoGluon 1.4 (best, 1h)",
    **_cpu_kwargs,
)

ag_140_bq_5m8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_bq_5m8c",
    name="AutoGluon 1.4 (best, 5m)",
    **_cpu_kwargs,
)

ag_140_hq_4h8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_hq_4h8c",
    name="AutoGluon 1.4 (high, 4h)",
    **_cpu_kwargs,
)

ag_140_hq_5m8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_hq_5m8c",
    name="AutoGluon 1.4 (high, 5m)",
    **_cpu_kwargs,
)

ag_140_hqil_4h8c_metadata = MethodMetadata.tabarena_public(
    method="AutoGluon_v140_hqil_4h8c",
    name="AutoGluon 1.4 (fast, 4h)",
    **_cpu_kwargs,
)

ag_140_hqil_5m8c_metadata = MethodMetadata.tabarena_public(
