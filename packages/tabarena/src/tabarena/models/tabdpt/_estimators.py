...
until it does, :func:`check_replica_signature` guards a ``tabdpt`` bump (run by the shared-weights
...
class _SharedNetworkEstimator(TabDPTEstimator):
    ...
    def __init__(  # noqa: PLR0917  # the library's positional signature, checked by check_replica_signature
        self,
