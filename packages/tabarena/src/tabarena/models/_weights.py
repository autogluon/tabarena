...
declare (see ``tabarena/models/tabicl/model.py`` for the plain case, ``tabdpt/_estimators.py`` and
``exaone_tabular/_estimators.py`` for the two libraries that load inside a constructor).
