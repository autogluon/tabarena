...
from tabarena.models.tabldm._vendor._model.kv_cache import TabLDMCache


class TabLDMBaseRegressor(RegressorMixin, TabLDMBaseEstimator):
    """Tabular In-Context Learning (TabLDM) Regressor with scikit-learn interface.

    This regressor applies TabLDM to tabular data regression, using an ensemble
    ...
    checkpoint_version : str, default='tabicl-regressor-v2-20260212.ckpt'
        ...
        Checkpoints are downloaded from https://huggingface.co/<your-hf-repo-id>.
    ...
    def __init__(
        ...
        checkpoint_version: str = "checkpoints/reg_stage3_moe1_step-10000.ckpt",
    ...
    def _load_model(self) -> None:
        ...
        self.model_ = TabLDM(**config)
        self.model_config_ = config
        self.model_.load_state_dict(checkpoint["state_dict"])
        self.model_.eval()

    def fit(self, X: np.ndarray, y: np.ndarray) -> TabLDMBaseRegressor:
    ...
    def predict(
        ...
        output_type : str or list of str, default="mean"
            ...
            - If ``"raw_quantiles"``, returns the raw quantiles (direct outputs of TabLDM).
