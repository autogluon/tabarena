...
The wrapper class(es) currently live at `tabarena.benchmark.models.ag.limix.limix_model`. This module
makes them available as `tabarena.models.limix.model`, giving per-model
