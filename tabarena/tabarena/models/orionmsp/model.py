...
The wrapper class(es) currently live at `tabarena.benchmark.models.ag.orionmsp.orionmsp_model`. This module
makes them available as `tabarena.models.orionmsp.model`, giving per-model
