...
if __name__ == "__main__":
    ...
    experiments_random = generate_bag_experiments(model_cls=GRANDEModel, configs=configs, time_limit=3600)
    experiments = experiments_default + experiments_random
    YamlExperimentSerializer.to_yaml(experiments=experiments, path="configs_grande.yaml")
